...
const en = {
  ...
  "sp2.sourceMonitorHint": "automatic status, uptime over 90 days, 30 days of bars",
...
export const statusPagesPart = {
  ...
  fr: {
    ...
    "sp2.sourceMonitorHint": "statut automatique, uptime sur 90 jours, 30 jours de barres",
  ...
  de: {
    ...
    "sp2.sourceMonitorHint": "automatischer Status, Verfügbarkeit über 90 Tage, 30 Tage Balken",
